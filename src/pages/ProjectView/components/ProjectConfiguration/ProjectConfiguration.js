// src/pages/ProjectView/components/ProjectConfiguration/ProjectConfiguration.js
...
export function ProjectConfiguration({
    ...
    return (
        <div className="bg-gray-800 rounded-lg p-4 space-y-1 h-fit">
            ...
            <PatternInputs
                ...
                onExcludeChange={onPatternChange}
